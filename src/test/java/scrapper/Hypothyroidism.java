...
public class Hypothyroidism extends BaseClass{
	...
	public static void filterRecipes() {
		...
		List<WebElement> recipes = new ArrayList<>();
		recipes=driver.findElements(By.xpath("//article[@class='rcc_recipecard']"));
...
//		       
//		        for(WebElement itemEle : recipes) {
//		        System.out.println(itemEle.getAttribute("id"));
